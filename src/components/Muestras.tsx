      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Nuestras <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Muestras</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Trabajamos con prendas para toda la familia, adaptándonos a cualquier estilo y ocasión
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
              <div key={item} className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg flex items-center justify-center hover:from-blue-100 hover:to-cyan-100 transition-colors duration-300 cursor-pointer">
